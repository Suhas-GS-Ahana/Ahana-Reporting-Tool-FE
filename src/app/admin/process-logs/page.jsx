    ...
    subProcesses: [
      {
        ...
        steps: [
          {
            executionId: "P1-SP1-S1-001",
            stepName: "Connect to Data Source",
            startTime: "09:00",
            endTime: "09:05",
            status: "Success",
          },
          {
            executionId: "P1-SP1-S2-001",
            stepName: "Retrieve Data Records",
            startTime: "09:05",
            endTime: "09:20",
            status: "Success",
          },
      ...
      },
      {
        ...
        steps: [
          {
            executionId: "P1-SP2-S1-001",
            stepName: "Cleanse Data",
            startTime: "09:20",
            endTime: "09:40",
            status: "Success",
          },
          {
            executionId: "P1-SP2-S2-001",
            stepName: "Normalize Data",
            startTime: "09:40",
            endTime: "10:00",
            status: "Failed",
          },
    ...
    subProcesses: [
      {
        ...
        steps: [
          {
            executionId: "P2-SP1-S1-002",
            stepName: "Identify Files for Backup",
            startTime: "11:00",
            endTime: "11:10",
            status: "Success",
          },
          {
            executionId: "P2-SP1-S2-002",
            stepName: "Create Backup Snapshot",
            startTime: "11:10",
            endTime: "11:20",
            status: "Success",
          },
          {
            executionId: "P2-SP1-S3-002",
            stepName: "Validate Snapshot Integrity",
            startTime: "11:20",
            endTime: "11:30",
            status: "Success",
          },
        ...
        <table className="min-w-full border border-collapse border-gray-200">
          ...
          <tbody>
            {executionData.map((process) => (
              <React.Fragment key={process.executionId}>
                {/* Process Row */}
                <tr
                ...
                {expandedProcesses[process.executionId] &&
                  process.subProcesses.map((subProcess) => (
                    <React.Fragment key={subProcess.executionId}>
                      <tr
